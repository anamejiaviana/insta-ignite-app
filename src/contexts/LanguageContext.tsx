...
const translations = {
  es: {
    ...
    recordingSessions: "Sesiones de grabación",
    allBusinesses: "Todos",
    noContent: "Sin contenido",
    generatedContentAppearsHere: "El contenido generado aparecerá aquí.",
    noWeeklyPlans: "Sin planes semanales",
    plansAppearHere: "Los planes que generes aparecerán aquí.",
    noRecordingSessions: "Sin sesiones de grabación",
